...
export default function HomePage() {
  return (
    <div className="min-h-screen bg-white text-gray-900">
      ...
      {/* Floating chat bubble (minimal change) */}
      <Link
        href="/chat"
        aria-label="Open Outfitly Chat"
        className="fixed right-4 bottom-4 z-50 group flex items-center gap-3"
      >
        <span className="hidden sm:inline-block rounded-full bg-white/90 px-3 py-2 text-sm font-medium text-zinc-900 shadow-md ring-1 ring-black/5 group-hover:bg-white">
          Chat here
        </span>
        <span className="relative flex h-14 w-14 items-center justify-center rounded-full bg-black text-white shadow-lg ring-2 ring-white/70 transition-transform hover:scale-105">
