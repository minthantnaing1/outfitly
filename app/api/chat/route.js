...
function getWeatherOutfitRecommendation(weather) {
  ...
  if (temp >= 30) {
    ...
    if (condition.includes("rain") || weather.humidity > 80) {
      recommendation = `🌦️ It's ${temp}°C with ${
        description || "rainy conditions"
      } in ${
        weather.location
      }. Perfect for layered spring looks! Try straight-leg jeans with a lightweight cardigan, white sneakers, and a stylish trench coat for rain protection.`;
  ...
  if (condition.includes("rain") || condition.includes("drizzle")) {
    recommendation +=
      " Trending rain gear: clear umbrellas, waterproof trench coats, and stylish rain boots! 🌧️";
    searchQuery += " rain umbrella";
  } else if (condition.includes("snow")) {
    recommendation +=
      " Snow day essentials: insulated boots, layered textures, and statement winter accessories! ❄️";
    searchQuery += " snow winter";
  } else if (condition.includes("wind") || weather.windSpeed > 5) {
    recommendation +=
      " Windy weather tip: secure scarves, avoid flowy pieces, and opt for structured silhouettes! 💨";
...
function getSeasonalTrends(season) {
  const trends = {
    spring:
      " 🌸 Spring 2025 trends: pastel colors, floral prints, and sustainable fabrics!",
    summer:
      " 🌺 Summer 2025 trends: vibrant colors, cut-out details, and breathable materials!",
    fall: " 🍁 Fall 2025 trends: earth tones, textured fabrics, and statement outerwear!",
    winter:
      " ❄️ Winter 2025 trends: rich jewel tones, luxe textures, and oversized silhouettes!",
  };
  ...
  const culturalOutfits = {
    ...
    japanese: {
      ...
      mild: {
        ...
        searchQuery:
          "japanese women haori kimono modern minimalist girls fashion",
      },
      cold: {
        recommendation:
        ...
        searchQuery:
          "japanese women winter kimono haori minimalist girls fashion",
      },
    },
    korean: {
      hot: {
    ...
    vietnamese: {
      ...
      cold: {
        ...
        searchQuery:
          "vietnamese women ao dai layered traditional girls fashion",
      },
    },
    chinese: {
      hot: {
      ...
      cold: {
        ...
        searchQuery:
          "chinese women cheongsam layered traditional girls fashion",
      },
    },
    singaporean: {
      hot: {
      ...
      mild: {
        ...
        searchQuery:
          "singaporean women baju kurung silk traditional girls fashion",
      },
      cold: {
        recommendation:
        ...
        searchQuery:
          "singaporean women baju kurung layered traditional girls fashion",
      },
    },
    malaysian: {
      hot: {
      ...
      mild: {
        ...
        searchQuery:
          "malaysian women baju kurung silk traditional girls fashion",
      },
      cold: {
        recommendation:
        ...
        searchQuery:
          "malaysian women baju kurung layered traditional girls fashion",
      },
    },
    indonesian: {
      hot: {
      ...
      mild: {
        ...
        searchQuery:
          "indonesian women batik dress silk traditional girls fashion",
      },
      cold: {
        recommendation:
        ...
        searchQuery:
          "indonesian women batik dress layered traditional girls fashion",
      },
    },
    african: {
      hot: {
    ...
    filipino: {
      ...
      mild: {
        ...
        searchQuery:
          "filipino women terno embroidery traditional girls fashion",
      },
      cold: {
        recommendation:
    ...
    italian: {
      ...
      mild: {
        ...
        searchQuery:
          "italian women blazer designer handbag milano girls fashion",
      },
      cold: {
        recommendation:
    ...
    spanish: {
      hot: {
        ...
        searchQuery:
          "spanish women flamenco dress espadrilles colorful girls fashion",
      },
      mild: {
        recommendation:
        ...
        searchQuery:
          "spanish women ruffled blouse statement earrings girls fashion",
      },
      cold: {
        recommendation:
    ...
    german: {
      ...
      mild: {
        ...
        searchQuery:
          "german women structured blazer quality basics girls fashion",
      },
      cold: {
        recommendation:
    ...
    dutch: {
      ...
      mild: {
        ...
        searchQuery:
          "dutch women cozy sweater waterproof practical girls fashion",
      },
      cold: {
        recommendation:
    ...
    russian: {
      hot: {
        ...
        searchQuery:
          "russian women blouse traditional patterns summer girls fashion",
      },
      mild: {
        recommendation:
        ...
        searchQuery:
          "russian women fur trim jacket elegant boots girls fashion",
      },
      cold: {
        recommendation:
        ...
        searchQuery:
          "russian women fur coat ushanka boots winter girls fashion",
      },
    },
    ...
    scandinavian: {
      hot: {
        ...
        searchQuery:
          "scandinavian women minimalist dress natural nordic girls fashion",
      },
      mild: {
        recommendation:
      ...
      cold: {
        ...
        searchQuery:
          "scandinavian women parka thermal nordic winter girls fashion",
      },
    },
    ...
    greek: {
      hot: {
        ...
        searchQuery:
          "greek women white dress gold accessories mediterranean girls fashion",
      },
      mild: {
        recommendation:
        ...
        searchQuery:
          "greek women draped fabric gold jewelry elegant girls fashion",
      },
      cold: {
        recommendation:
        ...
        searchQuery:
          "greek women mediterranean textile warm wraps girls fashion",
      },
    },
    ...
    american: {
      hot: {
        ...
        searchQuery:
          "american women denim shorts graphic tee sneakers girls fashion",
      },
      mild: {
        recommendation:
        ...
        searchQuery:
          "american women jeans blazer sneakers preppy girls fashion",
      },
      cold: {
        recommendation:
          "🇺🇸 Cozy American winter style! Try puffer jackets, warm boots, layered hoodies, and practical American winter wear with style!",
        searchQuery:
          "american women puffer jacket boots hoodie winter girls fashion",
      },
    },
    ...
    canadian: {
      hot: {
        ...
        searchQuery:
          "canadian women plaid shirt shorts hiking outdoor girls fashion",
      },
      mild: {
        recommendation:
        ...
        searchQuery:
          "canadian women flannel jeans practical outdoor girls fashion",
      },
      cold: {
        recommendation:
        ...
        searchQuery:
          "canadian women parka insulated boots toque winter girls fashion",
      },
    },
    ...
    mexican: {
      hot: {
        ...
        searchQuery:
          "mexican women embroidered blouse colorful vibrant girls fashion",
      },
      mild: {
        recommendation:
        ...
        searchQuery:
          "mexican women traditional embroidery colorful textile girls fashion",
      },
      cold: {
        recommendation:
        ...
        searchQuery:
          "mexican women rebozo layered traditional winter girls fashion",
      },
    },
    ...
    brazilian: {
      hot: {
        ...
        searchQuery:
          "brazilian women bikini cover up colorful beach girls fashion",
      },
      mild: {
        recommendation:
        ...
        searchQuery:
          "brazilian women form fitting dress bold prints girls fashion",
      },
      cold: {
        recommendation:
        ...
        searchQuery:
          "brazilian women tropical prints light jacket girls fashion",
      },
    },
    ...
    argentinian: {
      hot: {
        ...
        searchQuery:
          "argentinian women elegant dress heels sophisticated girls fashion",
      },
      mild: {
        recommendation:
        ...
        searchQuery:
          "argentinian women tailored leather boots sophisticated girls fashion",
      },
      cold: {
        recommendation:
          "🇦🇷 Cozy Argentinian winter style! Try warm coats, leather gloves, stylish boots, and elegant winter wear with Argentinian flair!",
        searchQuery:
          "argentinian women warm coat leather gloves winter girls fashion",
      },
    },
    ...
    australian: {
      hot: {
        ...
        searchQuery:
          "australian women bikini board shorts sun hat beach girls fashion",
      },
      mild: {
        recommendation:
        ...
        searchQuery:
          "australian women jeans casual tee sneakers outdoor girls fashion",
      },
      cold: {
        recommendation:
        ...
        searchQuery:
          "australian women layered casual boots light jacket girls fashion",
      },
    },
    ...
    newzealand: {
      hot: {
        ...
        searchQuery:
          "newzealand women outdoor dress hiking sandals adventure girls fashion",
      },
      mild: {
        recommendation:
        ...
        searchQuery:
          "newzealand women merino wool boots practical outdoor girls fashion",
      },
      cold: {
        recommendation:
        ...
        searchQuery:
          "newzealand women outdoor gear waterproof merino winter girls fashion",
      },
    },
  };
...
function detectKeywords(message) {
  ...
  const tempMatch = lowerMessage.match(
    /(\d+)\s*(?:degrees?|°|celsius|fahrenheit|c|f)/i
  );
  if (tempMatch) {
...
async function fetchOutfitImages(
  ...
  for (const source of imageSources) {
    try {
      console.log(
        `[v0] Trying to fetch from ${source.name} with query: ${searchQuery}`
      );
      const response = await fetchWithTimeout(
        `${baseUrl}${source.endpoint}?query=${encodeURIComponent(
          searchQuery
        )}&per_page=6&page=${randomPage}`,
        {},
        8000
      );
      ...
      if (response.ok) {
        ...
        if (images && images.length > 0) {
          console.log(
            `[v0] Successfully fetched ${images.length} regular images from ${source.name}`
          );
  ...
  if (culturalQuery && allImages.length > 0) {
    for (const source of imageSources) {
      try {
        console.log(
          `[v0] Trying to fetch cultural images from ${source.name} with query: ${culturalQuery}`
        );
        const response = await fetchWithTimeout(
          `${baseUrl}${source.endpoint}?query=${encodeURIComponent(
            culturalQuery
        ...
        if (response.ok) {
          ...
          if (images && images.length > 0) {
            console.log(
              `[v0] Successfully fetched 1 cultural image from ${source.name}`
            );
        ...
        console.error(
          `[v0] Error fetching cultural images from ${source.name}:`,
          error.message
        );
        continue;
      }
...
export async function POST(req) {
  try {
    ...
    console.log(
      "[v0] API Route: Received messages from client:",
    ...
    if (lastMessage.includes("hi") || lastMessage.includes("hello")) {
      ...
      if (detectedKeywords.cities.length > 0) {
        ...
        try {
          ...
          if (weatherResponse.ok) {
            ...
            console.log(
              "[v0] Weather API failed with status:",
      ...
      if (detectedKeywords.themes.length > 0) {
        const themeRec = getThemeOutfitRecommendation(
        ...
        if (themeRec) {
          ...
          if (weatherData) {
            recommendation += ` Perfect for ${weatherData.temperature}°C${
              weatherData.description &&
              weatherData.description !== "undefined" &&
              weatherData.description !== "null"
                ? ` and ${weatherData.description}`
                : ""
      ...
      if (detectedKeywords.cities.length > 0) {
        ...
        const culturalOutfit = getCulturalClothing(
          city,
          weatherData || { temperature: 20, condition: "clear" }
        );

        if (culturalOutfit) {
          const weatherInfo = weatherData
            ? `🌤️ It's ${weatherData.temperature}°C${
                weatherData.condition &&
                weatherData.condition !== "undefined" &&
                weatherData.condition !== "null"
                  ? ` and ${weatherData.condition}`
                  : ""
          ...
          const images = await fetchOutfitImages(
            searchQuery,
            culturalOutfit.searchQuery,
            baseUrl,
            randomPage
          );
          ...
          if (images.length > 0) {
            ...
            replyParts.push({
              type: "text",
              content: "Here are some outfit ideas for you:",
            });
            images.forEach((img) =>
              replyParts.push({
                type: "image",
